...
const LOCKED_FOOTER = `
    ...
    <mj-section background-color="#ffffff" padding="0 8px 28px 8px">
      <mj-column width="50%" padding="0 8px" border="1px solid #F8CD8B" border-radius="12px">
      ...
      <mj-column width="50%" padding="0 8px" border="1px solid #9AA3FF" border-radius="12px">
