...
const LOCKED_FOOTER = `
    ...
    <mj-section background-color="#ffffff" padding="0 4px 28px 4px">
      <mj-column width="50%" padding="0 12px" background-color="#FEF7EC" border="1px solid #F8CD8B" border-radius="12px">
      ...
      <mj-column width="50%" padding="0 12px" background-color="#EEF0FF" border="1px solid #9AA3FF" border-radius="12px">
