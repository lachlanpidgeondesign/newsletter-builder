...
const LOCKED_FOOTER = `
    ...
    <mj-section background-color="#ffffff" padding="0 0 28px 0">
      <mj-column width="50%" padding="0 8px 0 16px" border="1px solid #F8CD8B" border-radius="12px">
        <mj-text font-family="'Literata',Inter,Arial,Helvetica,sans-serif" font-size="17px" font-weight="800" color="#000000" padding="10px 12px 0 12px" line-height="1.2" container-background-color="#FEF7EC">Trace</mj-text>
        <mj-text font-family="Arial,Helvetica,sans-serif" font-size="12px" color="#333333" padding="4px 12px 8px 12px" line-height="1.4" container-background-color="#FEF7EC">Can you beat the clock?</mj-text>
        <mj-image src="https://i.dailymail.co.uk/i/pix/PuzzleReminder/Trace_260526.png" alt="Today's Trace Puzzle" padding="0" container-background-color="#FEF7EC" />
      ...
      <mj-column width="50%" padding="0 16px 0 8px" border="1px solid #9AA3FF" border-radius="12px">
        <mj-text padding="10px 12px 0 12px" line-height="1.2" container-background-color="#EEF0FF"><span style="font-family:'Literata',Inter,Arial,Helvetica,sans-serif;font-size:17px;font-weight:800;color:#000000;">Relink</span> <span style="display:inline-block;background-color:#191919;color:#ffffff;font-family:Arial,Helvetica,sans-serif;font-size:11px;font-weight:800;padding:3px 6px;border-radius:4px;text-transform:uppercase;float:right;">NEW</span></mj-text>
        <mj-text font-family="Arial,Helvetica,sans-serif" font-size="12px" color="#333333" padding="4px 12px 8px 12px" line-height="1.4" container-background-color="#EEF0FF">Find the imposters</mj-text>
        <mj-image src="https://i.dailymail.co.uk/i/pix/PuzzleReminder/Trace_260526.png" alt="Relink – find the secret link" padding="0" container-background-color="#EEF0FF" />
